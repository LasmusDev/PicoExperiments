...
public class QuestionnaireDummy : MonoBehaviour
{
    ...
    List<Stage> stageList = new List<Stage>() {
        new Stage() { headerText = "Test Header", modalText = "Test Question", buttonOption = "next"},
        new Stage() { headerText = "Test Header 2", modalText = "Test Question 2", buttonOption = "exit"}
    };
    // Logging
